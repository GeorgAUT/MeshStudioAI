...
MeshStudioAI is a collection of AI tools for adaptive meshing in the context of finite element methods (FEM). It builds on the approach taken in [G-Adaptivity](https://openreview.net/forum?id=pyIXyl4qFx): a GNN-based approach to adaptive mesh relocation for FEM.
